...
from api.views import Alarm,history,ImageUploadView,MyAPIView,UserRegistrationView,MyModelDetail,UserView,UserLoginView,UserProfileView,camiraView,UserChangePasswordView,SendPasswordResetEmailView,UserPasswordResetView,index
